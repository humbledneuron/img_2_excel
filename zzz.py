...
all_files = [file for file in os.listdir(folder_path)] # if file.endswith('.pdf')]
print(all_files)
"""
global bank_found, dates_found, amounts_found, payer_name_found, cuit_found, proof_number_found, extracted_text, bank, date, amount, payer, cuit, proof_number, bank_pattern, date_pattern, amount_pattern, proof_number_pattern, payer_name_pattern, cuit_pattern 
...
def extract_data_from_image(folder_path):
            pdf_to_image(folder_path)
        
            extract_image_to_text(folder_path)
