...
def pdf_to_image(pdf_file_path, output_image_path):
    ...
    c = canvas.Canvas(output_image_path, pagesize=letter)
    c.drawImage(first_page, 0, 0)
    c.save()
...
#            break
        ...
        # #'fo al' or 'foy' because it is not dectecting the CUenta DNI
            ...
            print(image_path)
            break
        # elif "xp uss" in line.lower(): # or 'xp uss' 'ars' coz #HSBC is not detected correctly either "xp" as bank symbol and "ARS" as currency
        #     print(line.lower())
        #     bank_name = "HSBC"
        #     print(bank_name)
        #     print(image_path)
        #     break
            """
        elif "usec" in line.lower(): # or 'xp uss' 'ars' coz #HSBC is not detected correctly either "xp" as bank symbol and "ARS" as currency
            print(line.lower())
            bank_name = "HSBC"
            print(bank_name)
            print(image_path)
